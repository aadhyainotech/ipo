...
// SERVICES
const save = require("../../../services/topGainLoser/save");
const list = require("../../../services/topGainLoser/list");
const update = require("../../../services/topGainLoser/update");
const deletelanguage = require("../../../services/topGainLoser/delete");
